...
import static io.hoopit.calendar.CompactCalendarView.FILL_LARGE_INDICATOR;
import static io.hoopit.calendar.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static io.hoopit.calendar.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    // CHANGED Created these two typeface to match it with the app's fonts
    ...
    CompactCalendarController(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs,
        ...
        // CHANGED Font for normal and semi bold date
        font_normal = ResourcesCompat.getFont(context, R.font.open_sans);
        font_bold = ResourcesCompat.getFont(context, R.font.open_sans_semibold);
    }
    ...
    private void init(Context context) {
        ...
        // CHANGED set custom font (open sans font)
        dayPaint.setTypeface(font_normal);
        ...
        for (int dayColumn = 0, colDirection = isRtl ? 6 : 0, dayRow = 0; dayColumn <= 6; dayRow++) {
            ...
            if (dayRow == 0) {
                ...
                if (shouldDrawDaysHeader) {
                    dayPaint.setColor(calenderTextColor);
                    // CHANGED set custom font (open sans font)
                    dayPaint.setTypeface(font_bold);
                    dayPaint.setStyle(Paint.Style.FILL);
                    dayPaint.setColor(calenderTextColor);
