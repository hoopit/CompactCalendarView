...
public class CompactCalendarView extends View {
    ...
    // CHANGED Created this method to set the duration of the collapsing animation
    public void setCollapseAnimDuration(int animDuration) {
        animationHandler.setHeightAnimDurationMillis(animDuration);
    }
