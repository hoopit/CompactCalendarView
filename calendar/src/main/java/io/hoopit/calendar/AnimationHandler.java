...
class AnimationHandler {
    // CHANGED made variable non static and non final as we changing the value. But a default value is set.
    private int heightAminDurationMillis = 650;
    ...
    void setHeightAnimDurationMillis(int animDurationMillis) {
        heightAminDurationMillis = animDurationMillis;
    }
    ...
    void openCalendar() {
        ...
        heightAnim.setDuration(heightAminDurationMillis);
